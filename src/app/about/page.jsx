      ...
      <div className='h-full overflow-scroll lg:flex' ref={containerRef}>
        ...
        <div className='p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2'>
          ...
          <div className='flex flex-col gap-12 justify-center'>
            {/* BIOGRAPHY IMAGE */}
            <Image src='https://websolutionmaster.com/_next/image?url=%2Fimages%2Fauthors%2Fsajjad.png&w=256&q=75' alt='Sajjad' width={112} height={112} className='w-28 h-28 rounded-full object-cover' />
            {/* BIOGRAPHY TITLE */}
            <h1 className='font-bold text-2xl'>BIOGRAPHY</h1>
            {/* BIOGRAPHY DESC */}
            <p className='text-lg'>Hello! I'm Sajjad, a passionate and creative Web Developer with over 11 years of experience in crafting dynamic and user-friendly websites and applications. With a Bachelor’s degree in Computer Science and a relentless drive to stay ahead of the latest technologies, I specialize in front-end development and have a growing expertise in back-end systems. My mission is to build seamless, efficient, and aesthetically pleasing digital experiences that drive user engagement and success for businesses and individuals alike.</p>
            {/* BIOGRAPHY QUOTE */}
            <span className='italic'>I'm always on the lookout for new challenges and opportunities to leverage my skills in web development to help businesses grow.</span>
            {/* BIOGRAPHY SIGN SVG*/}
            <div className='self-end'>Sajjad</div>
            ...
            <motion.div initial={{ x: "-300px" }} animate={isExperienceRefInView ? { x: "0" } : {}} className=''>
              ...
              <div className='flex justify-between h-48'>
                ...
                <div className='w-1/3 '>
                  ...
                  {/* JOB DESC */}
                  <div className='p-3 text-sm italic'>I led web development, offering expertise in JavaScript frameworks. </div>
                  {/* JOB DATE */}
                  <div className='p-3 text-red-400 text-sm font-semibold'>2024 - Present</div>
                  {/* JOB COMPANY */}
                  <div className='p-1 rounded bg-white text-sm font-semibold w-fit'>WSM</div>
                </div>
                {/* CENTER */}
              ...
              <div className='flex justify-between h-48'>
                ...
                <div className='w-1/3 '>
                  {/* JOB TITLE */}
                  <div className='bg-white p-3 font-semibold rounded-b-lg rounded-s-lg'>Senior Next.Js Developer</div>
                  {/* JOB DESC */}
              ...
              <div className='flex justify-between h-48'>
                ...
                <div className='w-1/3 '>
                  ...
                  {/* JOB DATE */}
                  <div className='p-3 text-red-400 text-sm font-semibold'>2012 - 2019 </div>
                  {/* JOB COMPANY */}
                  <div className='p-1 rounded bg-white text-sm font-semibold w-fit'>Upwork</div>
                </div>
                {/* CENTER */}
                <div className='w-1/6 flex justify-center'>
                  {/* LINE */}
